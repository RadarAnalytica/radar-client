...
import { fetchFiltersRnpAdd } from "./filtersRnpAddActions";
...
const filtersRnpAddSlice = createSlice({
    name: 'filtersRnpAdd',
    initialState,
    reducers: {
    ...
    extraReducers: (bulder) => {
        bulder
            .addCase(fetchFiltersRnpAdd.fulfilled, (state, action) => {
                return {
                    ...state,
...
export const { actions, reducer } = filtersRnpAddSlice;
