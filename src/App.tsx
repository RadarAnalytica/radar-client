        ...
        <FiltersProvider>
          <HelmetProvider>
            ...
            <Routes>
              ...
              <Route path='/operating-expenses' element={<ProtectedRoute underDevProtected testPeriodProtected expireProtected onboardProtected routeRuName='Операционные расходы'><OperatingExpenses /></ProtectedRoute>} />
