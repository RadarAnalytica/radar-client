...
export const positionTrackingTableCustomCellRender = (value: any, record: any, index: number, dataIndex: string, deleteProduct: (productId: string) => void) => {
    const [imageVisible, setImageVisible] = useState(false);
    if (dataIndex === 'actions') {
        return (
            <div className={styles.actionsCell}>
                <button onClick={() => deleteProduct(record.wb_id)} style={{ border: 'none', background: 'transparent', cursor: 'pointer' }}>
