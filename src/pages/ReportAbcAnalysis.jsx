...
const ReportAbcAnalysis = () => {
    ...
    const handleFiltersCollapse = () => {
        ...
        const clearedArticles = Object.keys(selectedArticles).reduce((acc, brand) => {
            acc[brand] = false;
            return acc;
        }, {});
    ...
    return (
        ...
        <div className='dashboard-page'>
            ...
            <div className={`${styles.scheduleMain} dashboard-content pb-3 `}>
                <TopNav title={<><span style={{ color: '#1A1A1A4D' }}>Отчет /</span> ABC-анализ</>} />
                ...
                <div className={`${styles.ScheduleBody} dash-container container`} style={{ marginTop: "20px" }}>
                    <div className={styles.containerProduct}>
                        <div className={styles.header}>
                            <span className={styles.title}>Товар</span>
                            <button className={styles.clearButton} onClick={handleCheckProduct}>
                    ...
                    {activeTab === 'revenue' && (
                        <div className={styles.containerRevenue}>
                            ...
                            <div className={styles.rowHeader}>
                                <div className={styles.article} style={{ color: "#8C8C8C" }}>Артикул</div>
                                <div className={styles.product} style={{ color: "#8C8C8C" }}>Товар</div>
                                <div className={styles.profit} style={{ color: "#8C8C8C" }}>Выручка</div>
                                <div className={styles.profitAmount} style={{ color: "#8C8C8C" }}>Доля выручки</div>
                                <div className={styles.category} style={{ color: "#8C8C8C" }}>Категория по выручке</div>
                                <div className={styles.generalCategory} style={{ color: "#8C8C8C" }}>Общая категория</div>
                            </div>
                    ...
                    {activeTab === 'profit' && (
                        <div className={styles.containerProfit}>
                            ...
                            <div className={styles.rowHeader}>
                                <div className={styles.article} style={{ color: "#8C8C8C" }}>Артикул</div>
                                <div className={styles.product} style={{ color: "#8C8C8C" }}>Товар</div>
                                <div className={styles.profit} style={{ color: "#8C8C8C" }}>Прибыль</div>
                                <div className={styles.profitAmount} style={{ color: "#8C8C8C" }}>Доля прибыли</div>
                                <div className={styles.category} style={{ color: "#8C8C8C" }}>Категория по выручке</div>
                                <div className={styles.generalCategory} style={{ color: "#8C8C8C" }}>Общая категория</div>
                            </div>
                                    ...
                                    <div className={styles.category}>
                                        {expandedRows[item.id]
                                            ...
                                            : (
                                                <div style={{ width: "23%", padding: "4px 0" }}>
                                                    <div style={{
                                                        backgroundColor: colorMap[item.profitCategory[0]] || 'transparent',
                                                        padding: '4px 16px',
                                                        borderRadius: '8px'
                                                    }}>{item.profitCategory[0]}</div>
                                                </div>
                                            )
                                        }
                                    </div>
