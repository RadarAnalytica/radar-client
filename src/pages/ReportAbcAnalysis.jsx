                ...
                <div className={`${styles.ScheduleFooter} dash-container container`}>
                    ...
                    <div className={styles.containerRevenue}>
                        ...
                        <div className={styles.rowHeader}>
                            ...
                            <div className={styles.profit}>Выручка</div>
                            <div className={styles.profitAmount}>Доля выручки</div>
                        ...
                        {data.map((item, index) => (
                            <div key={index} className={styles.row}>
                                <div className={styles.article}>
                                    <span onClick={() => toggleRow(item.id)} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
                                        {item.id}
                                        <img
                                ...
                                <div className={styles.profit}>{item.revenue}</div>
                                <div className={styles.profitAmount}>{item.revenueShare}</div>
                                <div className={styles.category}>{item.revenueCategory}</div>
                                <div className={styles.generalCategory}>{item.mainCategory}</div>
                            </div>
                        ))}
                    </div>
