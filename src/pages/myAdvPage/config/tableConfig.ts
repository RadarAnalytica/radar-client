...
export const getDefaultTableConfig = (): ColumnConfig[] => {
  const columns: ColumnConfig[] = [
    ...
    },
    {
      ...
      groupColor: 'white',
      children: [
        {title: 'Корзина', dataIndex: 'cart', sortable: true, fixed: false, canToggle: false, width: 50},
        {title: 'Заказы', dataIndex: 'orders', sortable: true, fixed: false, canToggle: false, width: 50},
        {title: 'Заказано, шт', dataIndex: 'order_item_count', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Прогноз выкуп, шт', dataIndex: 'expected_purchase', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Просмотры → Клик (CTR)', dataIndex: 'view_click', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Клик → Корзина', dataIndex: 'click_cart', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Корзина → Заказ', dataIndex: 'cart_order', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Просмотр → Заказ', dataIndex: 'view_order', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Прогноз Заказ → Выкуп', dataIndex: 'expected_order_purchase', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Прогноз Клик → Выкуп', dataIndex: 'expected_click_purchase', sortable: true, fixed: false, canToggle: true, width: 50},
      ].map(_ => ({ ..._, key: _.dataIndex, minWidth: _.width, maxWidth: TABLE_MAX_WIDTH }))
    },
    {
      ...
      groupColor: 'white',
      children: [
        {title: 'Просмотры', dataIndex: 'views', sortable: true, fixed: false, canToggle: false, width: 50},
        {title: 'Клики', dataIndex: 'clicks', sortable: true, fixed: false, canToggle: false, width: 50},
        {title: 'CPC', dataIndex: 'cpc', sortable: true, fixed: false, canToggle: true, width: 50}, 
        {title: 'Средний CPM за период', dataIndex: 'avg_cpm', sortable: true, fixed: false, canToggle: true, width: 50},
        // {title: 'Средняя позиция', dataIndex: 'avg_position', sortable: true, fixed: false, width: 50},
        {title: 'ДРР заказы', dataIndex: 'drr_orders', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Прогноз ДРР (по выкупу)', dataIndex: 'drr_purchase', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'CPCart', dataIndex: 'cp_cart', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'CPO', dataIndex: 'cpo', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Прогноз CPS', dataIndex: 'expected_cps', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Заказов на сумму', dataIndex: 'orders_amount', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Прогноз выкуп на сумму', dataIndex: 'expected_purchase_amount', sortable: true, fixed: false, canToggle: true, width: 50},
        {title: 'Расходы на рекламу', dataIndex: 'ad_spend', sortable: true, fixed: false, canToggle: true, width: 50},
