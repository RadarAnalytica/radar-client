...
export const CURR_REPORT_WEEK_COLUMNS_CONFIG_VER = '11';
...
export const COLUMNS = [
	...
	{title: 'Налоговая база', dataIndex: 'tax_base', sortable: true, width: 150, minWidth: 150, units: '₽', tooltipText: 'База для расчёта налога (см. п.11 Сводки продаж).'},
	{title: 'Налог', dataIndex: 'tax', sortable: true, width: 150, minWidth: 150, units: '₽', tooltipText: 'Сумма налога. Формула: Ставка налога × Налоговая база'},
