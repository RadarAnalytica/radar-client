        ...
        <div className='dashboard-page'>
            ...
            <div className="dashboard-content pb-3">
                ...
                <div className='search'>
                    <input type='text' placeholder='Поиск по SKU или артикулу' className='search-input' />
                    <div>
                        <img style={{marginLeft: '10px'}} src={SearchButton} alt="" />
                    </div>
                        <div className='d-flex' style={{gap: '20px', alignItems: 'center', marginLeft: '12vw'}}>
                            <div>
                                <img onClick={handleCostPriceShow} src={StockCostPrice} alt="" />
                            </div>
                            <div>
                                <img onClick={() => getFileClickHandler(authToken, activeBrand)} src={DownloadFile} alt="" />
                            </div>
                        </div>
