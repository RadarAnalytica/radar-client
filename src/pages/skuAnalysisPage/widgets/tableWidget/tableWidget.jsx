        ...
        <div className={styles.widget} style={{ borderRadius: isEndOfXScroll ? '16px' : '' }} onScroll={scrollHandler} ref={containerRef}>
            ...
            {tableConfig.map((t, id) => {
                ...
                return (
                    ...
                    <div className={tableStyle} key={id} style={{ boxShadow: t.isMain && isXScrolled ? '10px 0 10px -5px rgba(0, 0, 0, 0.1)' : 'none' }}>
                                                ...
                                                return (
                                                    <div className={`${styles.table__rowItem} ${styles.table__rowItem_wide}`} key={id}>
                                                        <div className={styles.table__rowImgWrapper}>
                                                            <img src={product.photo_url} width={30} height={40} />
                                                        </div>
                                                        <div className={styles.table__mainTitleWrapper}>
                                                            ...
                                                            <div className={styles.table__actionsWrapper}>
                                                                <Link to={product.url} target='_blank' className={styles.table__actionButton} title='Перейти к товару'>
