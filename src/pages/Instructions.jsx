                ...
                <div>
                    ...
                    <div className="sps-second">
                        ...
                        <div className='second-sub'>
                            ...
                            <h5 className="fw-bold mt-3">На следующем шаге установите расширение для Google Chrome</h5>
                            <div className='mb-2' style={{ padding: '30px 0', border: '1px solid rgba(19, 19, 19, 0.4)', borderRadius: '20px' }}>
                                <MiniDemo />
                            </div>
