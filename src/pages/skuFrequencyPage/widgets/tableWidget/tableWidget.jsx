...
import { tableConfig, formatRateValue, sortTableDataFunc } from '../../shared';
...
const tableMockData = [
    {
        product: 'Ремень+кожаный для брюк и джинс в подарок',
        wbFrequency: 174377,
        wbFrequencyRate: 54,
        demandRatio: 7.3,
        demandRatioRate: 0,
        ...
        sellersAmountRate: -4,
        qtyInTop: 4000,
        onWbProductsQuantity: 30000,
        onWbProductsQuantityRate: -8,
        revenueSpp: 174377,
        revenueSppRate: 60,
        avgDalyRevenue: 4000,
        sppPrice: 160900,
        sppPriceRate: 30,
        productsWithSales: 500,
        avgProductRevenue: 7000,
        avgProductRevenueFromSales: 4000,
        productsWithSalesRatio: 50,
        top30RevenueRatio: 20,
        avgReviewsQuantity: 3000,
        avgRating: 4.6,
        sellersWithSalesRatio: 70
    },
    {
        product: 'Ремень кожаный для брюк и джинс в подарок',
        wbFrequency: 174377,
                                                    ...
                                                    <div className={`${styles.table__rowItem} ${styles.table__rowItem_wide}`} key={`table_cell_${id}`} style={{ paddingLeft: '17px'}}>
                                                        <div className={styles.table__mainTitleWrapper}>
                                                            ...
                                                            <div className={styles.table__actionsWrapper}>
                                                                <Link to={`/dev/monitoring/request?query=${product[v.engName]}`} className={styles.table__actionButton}>
