...
import { fetchRequestsMonitoringData } from '../../../../redux/requestsMonitoring/requestsMonitoringActions';
...
const TableWidget = ({ tinyRows = false }) => {
    ...
    const { requestData, requestStatus, requestObject, tableConfig } = useAppSelector(store => store.requestsMonitoring)
