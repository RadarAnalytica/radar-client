...
export const newTableConfig = [
    ...
    },
    {
        ...
        children: [
            ...
            {sortDirections: ['ASC', 'DESC'], title: 'Кол-во продавцов', dataIndex: 'suppliers_quantity', width: 220, sorter: true, sortIcon: function ({ sortOrder }) { return <SortIcon sortOrder={sortOrder} ctx={this} /> }, filterOptions: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Кол-во товаров на WB', dataIndex: 'goods_quantity', width: 220, sorter: true, sortIcon: function ({ sortOrder }) { return <SortIcon sortOrder={sortOrder} ctx={this} /> }, filterOptions: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            ...
            {sortDirections: ['ASC', 'DESC'], title: 'Товаров с продажами', dataIndex: 'goods_with_sales_quantity_total', width: 220, sorter: true, sortIcon: function ({ sortOrder }) { return <SortIcon sortOrder={sortOrder} ctx={this} /> }, filterOptions: true, render: function (value) { return cellRender(value, this) }, hidden: false },
    ...
    },
    {
        ...
        children: [
            ...
            {sortDirections: ['ASC', 'DESC'], title: 'Кол-во товаров в ТОП-1200 за 30 дней, шт', dataIndex: 'top_goods_quantity', width: 220, sorter: true, sortIcon: function ({ sortOrder }) { return <SortIcon sortOrder={sortOrder} ctx={this} /> }, filterOptions: true, render: function (value) { return cellRender(value, this) }, hidden: false },
    ...
    },
    {
        ...
        children: [
            ...
            {sortDirections: ['ASC', 'DESC'], title: 'Артикулов с продажами, %', dataIndex: 'goods_with_sales_percent_300', width: 220, units: '%', sorter: true, sortIcon: function ({ sortOrder }) { return <SortIcon sortOrder={sortOrder} ctx={this} /> }, filterOptions: true, render: function (value) { return cellRender(value, this) }, hidden: false },
        ].map(_ => ({ ..._, render: _.render.bind(_) }))
    }
]
