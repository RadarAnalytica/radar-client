...
const tooltipConfig = {
    ...
    "Средняя цена (без СПП), ₽": 'Расчетное среднее значение за 30 дней',
...
export const newTableConfig = [
    ...
    },
    {
        ...
        groupColor: 'white',
        children: [
            {sortDirections: ['ASC', 'DESC'], title: getTitleWithTooltip('Рейтинг качества ниши'), dataIndex: 'niche_rating', width: 300, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Выручка (с СПП), ₽', dataIndex: 'revenue_total_spp', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Выручка (без СПП), ₽', dataIndex: 'revenue_total', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Ср. выручка в день, ₽', dataIndex: 'avg_daily_revenue', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Ср. цена (с СПП), ₽', dataIndex: 'avg_price_total_spp', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Ср. цена (без СПП), ₽', dataIndex: 'avg_price_total', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Товаров с продажами, шт', dataIndex: 'goods_with_sales_quantity_total', units: 'шт', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Ср. выручка на товар, ₽', dataIndex: 'avg_revenue_total', width: 220, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Ср. выручка на товар с продажами, ₽', dataIndex: 'avg_with_sales_revenue', width: 220, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Товаров с продажами, %', dataIndex: 'goods_with_sales_percent_total', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Ср. рейтинг', dataIndex: 'avg_rating', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Продавцов с продажами, %', dataIndex: 'suppliers_with_sales_percent', units: '%', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Кол-во товаров на WB, шт', dataIndex: 'goods_quantity', units: 'шт', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Кол-во продавцов, шт', dataIndex: 'suppliers_quantity', width: 220,units: 'шт', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: getTitleWithTooltip('Коэффициент cпроса'), dataIndex: 'freq_per_good', width: 300, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Частотность за 30 дней', dataIndex: 'frequency_30', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Частотность за 60 дней', dataIndex: 'frequency_60', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Частотность за 90 дней', dataIndex: 'frequency_90', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            // { title: '% выручки у ТОП-30 товаров, %', dataIndex: 'monopoly_percent', width: 220,  units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            //{title: 'Ср. кол-во оценок, %', dataIndex: 'avg_reviews', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
        ].map(_ => ({ ..._, render: _.render ? _.render.bind(_) : undefined, sortIcon: _.sortIcon?.bind(_), key: _.dataIndex, minWidth: _.width }))
    },
    {
        title: 'Динамика популярности и роста запросов',
        className: 'table__mainHeader_colored',
        ...
        groupColor: '#5329FF0D',
        children: [
            {sortDirections: ['ASC', 'DESC'], className: 'cell__red', title: 'Динамика запроса за 30 дней, %', dataIndex: 'g30', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], className: 'cell__red', title: 'Динамика запроса за 60 дней, %', dataIndex: 'g60', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], className: 'cell__red', title: 'Динамика запроса за 90 дней, %', dataIndex: 'g90', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
        ].map(_ => ({ ..._, render: _.render?.bind(_) , key: _.dataIndex, minWidth: _.width}))
    },
    {
        title: 'Дополнительные параметры',
        ...
        groupColor: 'white',
        children: [
            {sortDirections: ['ASC', 'DESC'], title: 'Процент выкупа, %', dataIndex: 'buyout_percent', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            //{title: 'Частотность за 30 дней', dataIndex: 'frequency_30', width: 220, sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title:  getTitleWithTooltip('Монопольность, %'), dataIndex: 'monopoly_percent', width: 300, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            //{title: 'Кол-во артикулов по запросу, шт', dataIndex: 'goods_quantity', width: 220,  units: 'шт', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Кол-во товаров в ТОП-1200 за 30 дней, шт', dataIndex: 'top_goods_quantity', width: 220, units: 'шт', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            //{title: 'Комиссия FBO, %', dataIndex: 'fbo_commision', width: 220,  units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
        ].map(_ => ({ ..._, render: _.render?.bind(_), key: _.dataIndex, minWidth: _.width }))
    },
    {
        title: 'У артикулов на первой странице',
        ...
        groupColor: '#5329FF0D',
        children: [
            {sortDirections: ['ASC', 'DESC'], className: 'cell__red', title: getTitleWithTooltip('Артикулов в рекламе, %'), dataIndex: 'advert_percent', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], className: 'cell__red', title: getTitleWithTooltip('Артикулов с внешним трафиком, %'), dataIndex: 'external_advert_percent', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], className: 'cell__red', title: 'Среднее кол-во отзывов у артикулов (без учета внутренней рекламы WB), шт', dataIndex: 'avg_reviews', width: 220, units: 'шт', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
        ].map(_ => ({ ..._, render: _.render?.bind(_), key: _.dataIndex, minWidth: _.width }))
    },
    {
        title: 'У артикулов на первых 3-х страницах',
        ...
        hidden: false,
        children: [
            {sortDirections: ['ASC', 'DESC'], title: 'Выручка за 30 дней (с СПП), ₽', dataIndex: 'revenue_300_spp', width: 240, units: '₽', filterOptions: true, sortable: true, sortIcon: function ({ sortOrder }) { return <SortIcon sortOrder={sortOrder} ctx={this} /> }, render: function (value) { return cellRender(value, this) }, hidden: false, comment: 'У артикулов на первых 3-х страницах' },
            {sortDirections: ['ASC', 'DESC'], title: 'Выручка за 30 дней (без СПП), ₽', dataIndex: 'revenue_300', width: 240, units: '₽', filterOptions: true, sortable: true, sortIcon: function ({ sortOrder }) { return <SortIcon sortOrder={sortOrder} ctx={this} /> }, render: function (value) { return cellRender(value, this) }, hidden: false, comment: 'У артикулов на первых 3-х страницах' },
            {sortDirections: ['ASC', 'DESC'], title: 'Средняя выручка за 30 дней (с СПП), ₽', dataIndex: 'avg_revenue_300_spp', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Средняя выручка за 30 дней (без СПП), ₽', dataIndex: 'avg_revenue_300', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Упущенной выручки за 30 дней, %', dataIndex: 'lost_revenue_percent_300', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
            {sortDirections: ['ASC', 'DESC'], title: 'Средняя цена (с СПП), ₽', dataIndex: 'avg_price_300_spp', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false, comment: 'У артикулов на первых 3-х страницах' },
            {sortDirections: ['ASC', 'DESC'], title: getTitleWithTooltip('Средняя цена (без СПП), ₽'), dataIndex: 'avg_price_300', width: 240, units: '₽', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false, comment: 'У артикулов на первых 3-х страницах' },
            {sortDirections: ['ASC', 'DESC'], title: getTitleWithTooltip('Артикулов с продажами, %'), dataIndex: 'goods_with_sales_percent_300', width: 220, units: '%', sortable: true, render: function (value) { return cellRender(value, this) }, hidden: false },
        ].map(_ => ({ ..._, render: _.render?.bind(_), key: _.dataIndex, minWidth: _.width }))
    }
]
