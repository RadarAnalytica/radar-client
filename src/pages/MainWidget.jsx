...
const MainWidget = () => {
  ...
  return (
    <div className='widget-main'>
      <div className='widmain-header'>
        <div className='container widhead-container'>
          <svg
            width='187'
            height='74'
            viewBox='0 0 200 74'
      ...
      <div className='container widbody-container'>
          ...
          <div className='sol-description col'>
            <div>
              <h2 className='fw-bold'>
                Расширение для аналитики на Wildberries
              </h2>
              <SolOptions />
            </div>
            <div
            ...
            >
              ...
              <h6 className='fw-bold'>
                Исследуйте свой рынок вместе с Radar Analytica, находите новые
                ниши и точно определяйте прибыльные товары
              </h6>
        ...
        <div className='wid-note'>
          <h3 className='fw-bold'>
            <span> Что покажет расширение </span>
            <YellowRadar /> <span> на Wildberries?</span>
          </h3>
          <p style={{ fontWeight: 600 }} className='col-8'>
            Вы сможете видеть аналитику, находясь в любой карточке товара
            на Wildberries, а также в результатах поиска, странице бренда
            и любой категории.
          </p>
        </div>
        ...
        <div className='wid-tools'>
          <div className='widtool-left col-4'>
            ...
            <p style={{ fontWeight: 600, fontSize: 20 }}>
              С помощью расширения можно отслеживать:
            </p>
            <SmallOptions />
            <p className='mt-3' style={{ fontWeight: 600, fontSize: 20 }}>
              по всем товарам на Wildberries
            </p>
          </div>
          <div className='widtool-right'>
            <div>
              ...
              <p className='fw-bold' style={{ fontSize: 20 }}>
                Очень удобный инструмент не только для анализа конкурентов,
                но и для оценки собственных продаж, в том числе на предмет
                допоставки.
              </p>
            </div>
            <div>
          ...
          <div className='wbp-left'>
            <div>
              ...
              <p style={{ fontSize: 25 }} className='pb-0 mt-2'>
                Отслеживайте динамику изменения выручки
              </p>
              <p style={{ fontSize: 20 }}>
                Предоставим удобные инструменты для отслеживания динамики
                выручки в зависимости от изменения цены.
              </p>
            </div>
            <div>
              <svg
              ...
              <p style={{ fontSize: 25 }} className='pb-0 mt-2'>
                Анализ категорий и запросов любой карточки товара на Wildberries
              </p>
              <p style={{ fontSize: 20 }}>
                Предоставим простые инструменты для анализа категорий и запросов
                любой карточки товара на Wildberries.
              </p>
            </div>
            <div>
              <svg
              ...
              <p style={{ fontSize: 20 }}>
                Посмотрите карточки, которые делают больше всего выручки
                на странице, оцените их упущенную выручку, продажи
                и проанализируйте диапазон цен.
              </p>
            </div>
          </div>
        ...
        <div className='widvideo-instruction'>
          <div className='widvideo'>Video</div>
        ...
        <div className='wid-slider'></div>

        <div className='widmain-cta'>
          <div
            className='d-flex slign-items-center justify-content-between'
            style={{ width: '100%' }}
          >
            <CtaLabel />
            <svg
          ...
          <p className='fw-bold mb-1' style={{ fontSize: 44 }}>
            Готовы начать?
          </p>
