        ...
        <div className='widget-main'>
            ...
            <div className="widmain-header">
                <div className="container widhead-container">
                    <svg width="187" height="74" viewBox="0 0 200 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="widheader-login">
                        <button className='prime-btn' style={{ width: '134px', height: '71px' }}>
                            Войти
                        </button>
                    </div>
                </div>
