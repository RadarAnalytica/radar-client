      ...
      <div className='container instruction-container col-10 container-xlwidth'>
        ...
        <div className='container col-10 pt-5 pb-5'>
          ...
          <span style={{ fontWeight: 600 }}>
            ...
            Настоящая политика конфиденциальности в отношении обработки
            ...
            данных, предпринимаемые Сервисом Radar Analytica (далее – Оператор).
            <br />
            ...
            <br />
            1.3. Использование сервисов веб-сайта https://radar-analytica.ru
            ...
            <br />
            5.2. Также на сайте происходит сбор и обработка обезличенных данных
            ...
            электронной почты info@radar-analytica.ru с пометкой «Отказ от
            ...
            являются: Об информации, информационных технологиях и о защите
            ...
            https://radar-analytica.ru или направленные Оператору посредством
            ...
            Оператора info@radar-analytica.ru с пометкой «Актуализация
            персональных данных».
            <br />
            ...
            info@radar-analytica.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
            <br />
            ...
            <br /> 12.1. Оператор до начала осуществления трансграничной
            ...
            <br /> 12.2. Трансграничная передача персональных данных на
            ...
            info@radar-analytica.ru.
            <br /> 14.2. В данном документе будут отражены любые изменения
            политики обработки персональных данных Оператором. Политика
            действует бессрочно до замены ее новой версией.
            <br /> 14.3. Актуальная версия Политики в свободном доступе
