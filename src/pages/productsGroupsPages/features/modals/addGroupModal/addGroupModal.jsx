        ...
        >
            <div className={styles.modal}>
                <div className={styles.modal__header}>
                    ...
                    <p className={styles.modal__title}>Создание группы товаров</p>
                </div>
                ...
                <div className={styles.modal__inputWrapper}>
                    <label className={styles.modal__inputLabel}>Магазин</label>
                    <ConfigProvider
                        theme={{
                            token: {
                                colorPrimary: '#d9d9d9'
                    ...
                    >
                        <Select
                            ...
                            options={shops.filter(_ => (_.is_primary_collect && _.is_valid)).map(i => ({ value: i.id, label: i.brand_name }))}
                            suffixIcon={
