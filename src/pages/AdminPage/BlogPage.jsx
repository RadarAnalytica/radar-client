    ...
    return (
        <main className={styles.page}>
            ...
            <section className={styles.page__content}>
                ...
                {activePage === 'Список статей' && postIdForUpdate && <BlogUpdate post={posts.find(_ => _.id === postIdForUpdate)} categories={categories} setPostIdForUpdate={setPostIdForUpdate} token={authToken} />}
