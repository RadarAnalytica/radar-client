  ...
  return (
    <div className='linked-shops-page'>
      ...
      <div className='linked-shops-content'>
        ...
        <div
          className='container dash-container linked-shops-container d-flex  align-items-center justify-content-center'
          style={{
            // padding: "12px 20px",
            // marginLeft: "50px",
            gap: "20px",
            // maxWidth: "78vw !important",
          }}
        >
          <div className='row linked-wrap row-linked-shop p-0'>
            {shops && shops.length
              ? shops.map((item, i) => (
                <div className='linked-shop-block col' key={i}>
                  <div>
