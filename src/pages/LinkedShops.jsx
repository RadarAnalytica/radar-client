    ...
    <div className='linked-shops-page'>
        ...
        <Modal.Body>
          ...
          <div className='d-flex justify-content-between w-100 mt-2'>
            <button
              ...
              onClick={() => {
                ServiceFunctions.updateToken(brandName, tkn, authToken);
                handleClose();
                setShowSuccess(true);
              }}
            >
      ...
      >
        ...
        <Modal.Body>
          ...
          >
            {' '}
            <a className='link mb-0 pb-0'>Загрузить данные</a>
          </div>
          ...
          <div className='d-flex justify-content-between w-100 mt-2'>
            <button
              ...
              style={{ padding: '16px 20px' }}
              onClick={() => {
                editShop(activeShop, true, false, authToken, brandName, tkn);
                setShowEdit(false);
              }}
            >
              Сохранить
      ...
      >
        ...
        <Modal.Body>
          <p>
            ...
            <a href='/development/dashboard' className='link'>
              Сводка продаж
            </a>
          </p>
          <div className='d-flex justify-content-between'>
            <div className='grey-block d-flex align-items-center'>
              <p className='col mb-0' style={{ fontSize: '14px' }}>
                Для максимального использования всего функционала, внесите
                себестоимость ваших товаров
              </p>
              <button
                className='prime-btn col'
                style={{
                  fontSize: '13px',
                  height: '75%',
                  padding: '12px 12px',
