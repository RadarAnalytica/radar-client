...
const LinkedShops = () => {
    ...
    return (
        <div className='linked-shops-page'>
                                    ...
                                    <div className="linked-shop-block col me-2" key={i}>
                                        <div>
                                            ...
                                            <div className="d-flex gap-2 mt-3">
                                                {/* EDIT */}
                                                <svg onClick={() => { setActiveShop(item); setShowEdit(true) }} style={{ cursor: 'pointer' }} width="168" height="42" viewBox="0 0 168 42" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* DELETE */}
            <Modal show={showDelete} onHide={() => setShowDelete(false)} className='add-token-modal'>
                <Modal.Body>
                    <div className="d-flex justify-content-between">
                        <h4 className="fw-bold mb-0">Удалить магазин {activeShop?.brandName}?</h4>
                    </div>
            ...
            {/* SUCCESS */}
            <Modal show={showSuccess} onHide={() => setShowSuccess(false)} className='add-token-modal'>
                <Modal.Header closeButton>
                    <div className="d-flex align-items-center gap-2">
                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* SELFCOST */}
            <Modal show={showSelfcost} onHide={() => setShowSelfcost(false)} className='add-token-modal'>
                <Modal.Header closeButton>
                    <div className="d-flex align-items-center gap-2">
                        <div style={{ width: '100%' }}>
                            <div className="d-flex justify-content-between">
                ...
                <Modal.Body>
                    {
                        file ?
                            <div>
                                ...
                                <div className="d-flex justify-content-center w-100 mt-2 gap-2">
                                    <a href="#" className='link'>Отмена</a>
                                </div>
                            </div>
                            :
                            <div>
