		...
		useEffect(() => {
			if (editData) {
				...
				form.setFieldsValue({
					...
					selection: 'shop',
					shops: Array.isArray(editData.shop) ? editData.shop?.map((el) => el.id) : [editData.shop?.id],
					vendor_codes: Array.isArray(editData.vendor_code) ? editData.vendor_code?.map((el) => el.id) : [editData.vendor_code?.id],
					brand_names: Array.isArray(editData.brand_name) ? editData.brand_name?.map((el) => el.id) : [editData.brand_name?.id],
					frequency: 'week',
					week: editData.week,
