            ...
            >
              ...
              <FilterGroup
                ...
                onSelect={(value) => {
                  ...
                  // Otherwise handle single selection
                  const currentValues = Array.isArray(activeFilters['article'])
                    ? activeFilters['article']
                    : [];
                  const newValues = currentValues.includes(value)
                    ? currentValues.filter((v) => v !== value)
              ...
              <FilterGroup
                ...
                onSelect={(value) => {
                  ...
                  // Otherwise handle single selection
                  const currentValues = Array.isArray(activeFilters['country'])
                    ? activeFilters['country']
                    : [];
                  const newValues = currentValues.includes(value)
                    ? currentValues.filter((v) => v !== value)
              ...
              <FilterGroup
                ...
                onSelect={(value) => {
                  ...
                  // Otherwise handle single selection
                  const currentValues = Array.isArray(activeFilters['subject'])
                    ? activeFilters['subject']
                    : [];
                  const newValues = currentValues.includes(value)
                    ? currentValues.filter((v) => v !== value)
