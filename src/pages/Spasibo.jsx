                    ...
                    <div className="sps-bottom">
                        <div className="bottom-first">
                            ...
                            <p style={{ fontSize: '20px' }}>
                                Внешняя аналитика, конкурентный анализ, внутренняя аналитика по Api-ключу, мощные инструменты SEO-продвижения
                            </p>
                        </div>
                        <div className="bottom-second">
                            <div className='grey-block-btm'>
                                <div className="col-8">
                                    ...
                                    <h6 className="fw-bold">
                                        Мощные инструменты внутренней аналитики для увеличения прибыли на маркетплейсах
                                    </h6>
                                </div>
                            ...
                            <div className='bottom-last mb-5'>
                                <h3 className="fw-bold">А для удобства - переходите в наш бесплатный бот</h3>
                                <p style={{ fontWeight: '600' }}>Вы сможете видеть всю статистику по магазину прямо в телефоне</p>
