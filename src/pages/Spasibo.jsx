                        ...
                        <div className="top-right-spasibo col">
                            ...
                            <div className="col top-right">
                                <a href="https://marketplace-radar.ru/" className='sps-lk'>
                                    ...
                                    <span style={{ color: 'white' }} className='me-2'>Оцифровка личного кабинета</span>
                                    <span>
                                        <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="sps-second">
                        <div>
                            <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M13 26.5L21.7929 35.2929C22.1834 35.6834 22.8166 35.6834 23.2071 35.2929L40.5 18" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        ...
                        <div className='second-sub'>
                            ...
                            <a href="https://www.wildberries.ru/catalog/154750075/detail.aspx" className="prime-btn sps__wb-link" style={{ display: 'inline-block', paddingBlock: '20px', minHeight: '63px', width: '100%', textDecoration: 'none', fontSize: '18px', textAlign: 'center' }}>
                    ...
                    <div className="container footer-container">
                        <div className="row">
                            ...
                            <div className="col pt-3 footer-col">
                                <a href="https://t.me/SpyRadar_bot" style={{ textDecoration: 'none', color: 'black' }} className='fw-bold'>Telegram-бот</a>

                            </div>
                            <div className="col pt-3 footer-col">
                                <a href="#" style={{ textDecoration: 'none', color: 'black' }} className='fw-bold'>Контакты</a>

                            </div>
                            <div className="col-3 pt-3 footer-col">
                                <a href='/politics' className="fw-bold" style={{ textDecoration: 'none', color: 'black' }}>Политика конфиденцильности</a>
