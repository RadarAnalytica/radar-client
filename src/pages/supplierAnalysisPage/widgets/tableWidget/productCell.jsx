...
export const ProductCell = ({value, rowData }) => {
    ...
    return (
        ...
        <div className={styles.table__mainTitleWrapper}>
            <p className={styles.table__rowTitle}>{value}</p>
            <div className={styles.table__actionsWrapper}>
                <Link to={rowData?.wb_id_url} target='_blank' className={styles.table__actionButton} title='Перейти к товару'>
                ...
                <CopyButton url={rowData?.wb_id_url} />
            </div>
        </div>
