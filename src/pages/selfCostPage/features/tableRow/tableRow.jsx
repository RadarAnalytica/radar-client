...
const TableRow = ({ tableConfig, currentProduct, getTableData, authToken, setDataStatus, initDataStatus, shopId }) => {
    ...
    const [fulfilmentValue, setFullfilmentValue] = useState(product.fullfillment)
            ...
            >
                ...
                <div className={styles.row__item}>
                    ...
                    <button
                        ...
                        disabled={(product.cost && product.cost.toString() === selfCostValue) && (product.fulfillment && product.fulfillment.toString() === fulfilmentValue)}
                    >
