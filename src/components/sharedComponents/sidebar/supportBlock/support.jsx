...
const Support = ({ isMenuHidden }) => {
    ...
    return (
        <Link to='https://t.me/radar_analytica_support' target="_blank" className={isMenuHidden ? `${styles.support} ${styles.support_hidden}` : styles.support} onClick={() => {dispatch(utilsActions.setIsSidebarHidden(true));}}>
