...
const BigChartGlitter = ({ name, loading, data, days, orderOn, salesOn, setOrderOn, salesLineOn, orderLineOn, maxValue, maxAmount, setSalesOn, setByMoney, byMoney, byAmount, setOrderLineOn, setSalesLineOn, dataDashBoard, returnOn, setReturnOn, setReturnLineOn, returnLineOn }) => {
        ...
        <div className='big-chart'>
            <div className="d-flex justify-content-between align-items-center">
                ...
                <div className='d-flex align-items-center' style={{ cursor: 'pointer' }}>
                    ...
                    <div className='d-flex me-3 aligin-items-center' onClick={() => setReturnOn(!returnOn)}>
                        {
                            returnOn ?
                                <svg style={{ width: '2.5vh', marginRight: '0.5vh' }} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label style={{ cursor: 'pointer' }} htmlFor="sales">Возвраты, шт</label>
                    </div>
                                        ...
                                        external: function (context) {
                                            ...
                                            if (tooltipModel.body) {
                                                ...
                                                datasets?.forEach(function (set, i) {
                                                    const colors = ['rgba(240, 173, 0, 1)', 'rgba(83, 41, 255, 1)', 'rgba(249, 60, 101, 1)']
                                                    const targetColor = set.label === 'Заказы' ? colors[0] : (set.label === 'Возвраты' ? colors[2] : (set.label === 'Продажи' ? colors[1] : ''));
