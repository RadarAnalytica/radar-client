...
import financeIcon from '../assets/financeLogo.png';
import financeIconGrey from '../assets/financeLogoGrey2.png';
    ...
    <div className='side-nav'>
      <div>
        ...
        <div style={{marginTop: '1.5em'}}>
          ...
          >
            <div className='d-flex align-items-center'>
              <svg className='side-nav-icon' viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg"
                fill={location === 'orders-map' ||
                  location === 'supply' ||
                  location === 'abc-data' ||
          ...
          >
            <div className='d-flex align-items-center'>
              <svg className='side-nav-icon' viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                fill={
                  location === 'calculate' ||
                  location === 'monitoring' ||
