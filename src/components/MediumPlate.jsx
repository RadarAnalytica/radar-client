...
const MediumPlate = ({ name, value, quantity, percent, percent2, text, text2, dataDashBoard, days }) => {
    ...
    const getIcon = (name) => {
        switch (name) {
            case 'Заказы':
                return <svg style={{ position: 'absolute', right: '0', top: '0', width: '3.25vw' }} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            case 'Продажи':
                return <svg style={{ position: 'absolute', right: '0', top: '0', width: '3.25vw' }} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path opacity="0.5" d="M24.9131 34.175C24.3255 34.8018 23.3411 34.8335 22.7143 34.246C22.0876 33.6584 22.0558 32.674 22.6434 32.0472L28.4767 25.825C29.045 25.2189 29.9893 25.1663 30.6213 25.7056L35.2253 29.6344L41.224 22.0361C41.7563 21.3618 42.7345 21.2467 43.4088 21.7791C44.0831 22.3114 44.1982 23.2896 43.6658 23.9639L36.6658 32.8306C36.1191 33.5231 35.1063 33.6227 34.4351 33.05L29.7311 29.0358L24.9131 34.175Z" fill="#4AD991" />
                </svg>
            case 'Возвраты':
                return <svg style={{ position: 'absolute', right: '0', top: '0', width: '3.25vw' }} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect opacity="0.21" width="60" height="60" rx="10" fill="#FF9066" />
                    <path opacity="0.901274" fill-rule="evenodd" clip-rule="evenodd" d="M22.7214 15.1789C22.4573 14.8642 21.9474 14.9846 21.852 15.3843L20.2186 22.2324C20.1409 22.5581 20.3989 22.8666 20.7332 22.8477L27.778 22.4484C28.1889 22.4252 28.3972 21.9431 28.1327 21.6278L26.3314 19.4811C27.4963 19.083 28.7316 18.8751 30 18.8751C36.2592 18.8751 41.3333 23.9492 41.3333 30.2084C41.3333 36.4676 36.2592 41.5417 30 41.5417C23.7408 41.5417 18.6667 36.4676 18.6667 30.2084C18.6667 29.1576 18.809 28.1285 19.0864 27.1394L16.5188 26.4192C16.1808 27.6243 16 28.8953 16 30.2084C16 37.9404 22.268 44.2084 30 44.2084C37.732 44.2084 44 37.9404 44 30.2084C44 22.4764 37.732 16.2084 30 16.2084C28.055 16.2084 26.2027 16.605 24.5195 17.3218L22.7214 15.1789Z" fill="#FF9066" />
                </svg>
