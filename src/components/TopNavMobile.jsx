...
const TopNavMobile = ({ title, children, subTitle }) => {
    ...
    return (
        <div className='top-nav' style={{ backgroundColor: "black!important" }}>
            <div className='container dash-container d-flex align-items-center justify-content-between p-3'>
                <div className='d-flex col me-2'>
                    ...
                    {children}
                    <span className='col-2 d-flex justify-content-around top-menu '>
