...
const SalesTable = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.header} style={{width: '260%'}}>
        ...
        <div className={styles.headerSection}>
          ...
          <div className={styles.flexContainer}>
            <div className={`${styles.purchaseCell} ${styles.greyColor}`}>Выкупы</div>
            <div className={`${styles.returnCell} ${styles.greyColor}`}>Возвраты</div>
            <div className={`${styles.salesCell} ${styles.greyColor}`}>Продажи</div>
            <div className={`${styles.revenueCell} ${styles.greyColor}`}>Выручка</div>
            <div className={`${styles.avgPriceCell} ${styles.greyColor}`}>Ср. цена продажи</div>
            <div className={`${styles.sppCell} ${styles.greyColor}`}>СПП</div>
            <div className={`${styles.buyoutCell} ${styles.greyColor}`}>Выкуп</div>
          </div>
        </div>

        {/* Cost Section */}
        <div className={` ${styles.headerSection} ${styles.costSection} ${styles.diffBacckground}`}>
          <div className={styles.headerText}>Себестоимость</div>
          <div className={`${styles.flexContainer} ${styles.costContainer}`}>
            <div className={`${styles.costCell} ${styles.greyColor}`}>Себестоимость</div>
            <div className={`${styles.costPerUnitCell} ${styles.greyColor}`}>Себестоимость на единицу</div>
          </div>
        </div>
        ...
        <div className={styles.headerSection}>
          ...
          <div className={styles.flexContainer}>
            <div className={`${styles.deliveryCountCell} ${styles.greyColor}`}>Кол-во доставок</div>
            <div className={`${styles.commissionCell} ${styles.greyColor}`}>Комиссии</div>
            <div className={`${styles.acquiringCell} ${styles.greyColor}`}>Эквайринг</div>
            <div className={`${styles.logisticsCell} ${styles.greyColor}`}>Логистика доставок</div>
            <div className={`${styles.logisticsCell} ${styles.greyColor}`}>Логистика возвратов</div>
            <div className={`${styles.logisticsCell} ${styles.greyColor}`}>Логистика склад</div>
            <div className={`${styles.logisticsCell} ${styles.greyColor}`}>Логистика на единицу</div>
          </div>
        </div>
        ...
        <div className={styles.headerSection}>
          ...
          <div className={styles.flexContainer}>
            <div className={`${styles.defectCompnesaitionCell} ${styles.greyColor}`}>Компенсации брака</div>
            <div className={`${styles.defectQuantityCell} ${styles.greyColor}`}>Кол-во брака</div>
            <div className={`${styles.damageCompensationCell} ${styles.greyColor}`}>Компенсации ущерба</div>
            <div className={`${styles.damageQuantityCell} ${styles.greyColor}`}>Кол-во <br/>ущерба</div>
            <div className={`${styles.finesCell} ${styles.greyColor}`}>Штрафы</div>
            <div className={`${styles.payMoreCell} ${styles.greyColor}`}>Доплаты</div>
            </div>
        </div>
        ...
        <div className={styles.headerSection}>
          ...
          <div className={styles.flexContainer}>
            <div className={`${styles.defectCompnesaitionCell} ${styles.greyColor}`}>Затраты на самовыкупы</div>
            <div className={`${styles.defectCompnesaitionCell} ${styles.greyColor}`}>Внешние расходы</div>
            <div className={`${styles.defectCompnesaitionCell} ${styles.greyColor}`}>Всего внешних расходов</div>
            </div>
            </div>
      </div>
