      ...
      {dataDashBoard === null || dataDashBoard === undefined || loading ? (
        ...
        >
          ...
          >
            ...
            {name === 'Комиссия WB' && (
              <TooltipInfo text='Суммарная комиссия маркетплейса, определяются из финансовых отчетов и расчетным способом от суммарного объема продаж по коэффициентам, определенным Wildberries, за текущую неделю' />
            )}
            {name === 'Расходы на логистику' && (
              <TooltipInfo text='Суммарные расходы на логистику, определяются из финансовых отчетов и расчетным способом от количества заказов за текущую неделю' />
            )}
            {name === 'Хранение' && (
