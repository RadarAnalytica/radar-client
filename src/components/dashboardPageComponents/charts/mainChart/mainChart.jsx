...
const initChartControlsState = [
    ...
    { key: 'logistic', title: 'Логистика', color: '#FFDC89', units: 'руб', YAxis: 'A', isActive: true },
    { key: 'net_profit', title: 'Чистая прибыль', color: '#C7D61E', units: 'руб', YAxis: 'A', isActive: true },
    { key: 'returns_count', title: 'Возвраты', color: '#5F00B2', units: 'шт', YAxis: 'B', isActive: true },
    { key: 'returns_sum', title: 'Возвраты', color: '#ADADAD', units: 'руб', YAxis: 'A', isActive: true },
    { key: 'advert_amount', title: 'Реклама', color: '#FF0000', units: 'руб', YAxis: 'A', isActive: true },
    { key: 'avg_logistics_per_unit', title: 'Средняя стоимость логистики на 1 шт', color: '#1BC5D1', units: 'руб', YAxis: 'A', isActive: true },
    { key: 'buyout_percent', title: 'Выкуп', color: '#B53B32', units: '%', YAxis: 'C', isActive: true },
    { key: 'commission', title: 'Комиссия', color: '#00AF4F', units: '%', YAxis: 'C', isActive: true },
    { key: 'operating_expense', title: 'Опер. расходы', color: '#0014C3', units: 'руб', YAxis: 'A', isActive: true },
...
const MainChart = memo(({ title, loading, dataDashBoard, selectedRange, dragHandle }) => {
    ...
    const [controlsState, setControlsState] = useState(initChartControlsState);
    ...
    return (
        <>
            ...
            {/* Main */}
            {!loading &&
                <div className={styles.chart} style={{ height: isChartVisible ? '500px' : 'auto' }}>
