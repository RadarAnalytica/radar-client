            ...
            <div className="container footer-container">
                <div className="row" >
                    ...
                    <div className="col pt-1 footer-col">
                        ...
                        <a className='footer-link' href='#'>START на Маркетплейсах </a>
                        <a className='footer-link' href='#'>SEO-продвижение </a>
                        <a className='footer-link' href='#'>Сопровождение </a>
                        <a className='footer-link' href='#'>Комплексный маркетинг  </a>
                        <a className='footer-link' href='#'>Спец.проекты  </a>
                        <a className='footer-link' href='#'>Тарифы  </a>
                    </div>
                    <div className="col pt-1 footer-col">
                        <h6 className='fw-bold'>Сервис</h6>
                        <a className='footer-link' href='#'>Расширение </a>
                        <a className='footer-link' href='#'>Telegram-бот </a>
                        <a className='footer-link' href='#'>Партнерская программа  </a>
                    </div>
                    <div className="col pt-1 footer-col">
                        <h6 className='fw-bold'>Обучение</h6>
                        <a className='footer-link' href='#'>Бесплатная база знаний</a>
                        <a className='footer-link' href='#'>Авторские курсы от экспертов «Radar Analytica»</a>
                        <a className='footer-link' href='#'>Вебинары </a>
                    </div>
                    <div className="col pt-1 footer-col">
                        <h6 className='fw-bold'>О компании</h6>
                        <a className='footer-link' href='#'>О нас</a>
                        <a className='footer-link' href='#'>Контакты</a>
                        <a className='footer-link' href='#'>Вакансии</a>
                    </div>
                </div>
            </div>
        </div>
