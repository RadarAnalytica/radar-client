    ...
    return (
        <div className='order-table-extended'>
            ...
            <div className='d-flex justify-content-between'>
                ...
                <p className="mb-2 clue-text col-3">Рубли</p>
                <p className="mb-2 clue-text col-2 text-center">Общая доля</p>
                <p className="mb-2 clue-text col-2 fw-bold text-end">По складу</p>
            </div>
            {
                data && data.data && data.data.length ?
                    data.data.map((item, key) => (
                        <div key={key} className='d-flex'>
                            ...
                            <p style={{ fontWeight: 600 }} className="mb-2 col-3">{(item.sum)?.toFixed(1)} ₽</p>
                            <p style={{ fontWeight: 600 }} className="mb-2 col-2 text-center">{(item.percent)?.toFixed(1)}%</p>
