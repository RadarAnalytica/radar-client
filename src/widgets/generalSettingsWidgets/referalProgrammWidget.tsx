...
import styles from './referalProgrammWidget.module.css';
import { ServiceFunctions } from '@/service/serviceFunctions';
import { ConfigProvider, Flex, Row, Tooltip, Button, Col, Table } from 'antd';
import { HeaderIcon, TooltipIcon, CopyIcon } from './icons';
...
export function ReferalProgrammWidget() {
	...
	const copyHandler = () => {
		navigator.clipboard
			...
			.then(() => {
				(copyInput?.current as HTMLElement)?.classList.add(styles.partner__input_copied);
				setTimeout(() => {
					(copyInput?.current as HTMLElement)?.classList.remove(
							...
							<Flex className={styles.tiles} gap={8}>
								...
								>
									...
									>
										...
										<Tooltip 
										color='white'
										title="Вы получаете % от каждой оплаты подписки ваших рефералов в течение этого срока с момента их регистрации"
										style={{ fontSize: '12px'}}
										>
											<span>
												<TooltipIcon
						...
						<div className={styles.row}>
							<div className={styles.col}>
								<div className={styles.info}>
									<p className={styles.info__title} style={{ color: '#1A1A1A80' }}>
								...
								<div className={styles.info}>
									<Flex gap={12} align="center">
										...
										<Button
											...
											style={{ fontSize: 14, height: 46, fontWeight: 600, borderRadius: 8 }}
										>
											Вывести
										</Button>
									</Flex>
