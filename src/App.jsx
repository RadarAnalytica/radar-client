      ...
      <ProductProvider>
        <HelmetProvider>
          ...
          <Routes>
            ...
            <Route path='/operations-costs' element={<ProtectedRoute underDevProtected userRoleProtected testPeriodProtected expireProtected onboardProtected routeRuName='Операционные расходы'><OperationsCosts /></ProtectedRoute>} />
            ...
            <Route path='/rnp' element={<ProtectedRoute underDevProtected testPeriodProtected expireProtected onboardProtected routeRuName='Рука на пульсе'><Rnp /></ProtectedRoute>} />
            {/* Public routes */}
