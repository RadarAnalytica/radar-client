    ...
    <AuthProvider>
      <ProductProvider>
        <Routes>
          ...
          <Route path='/sku-analysis/:id' element={<ProtectedRoute expireProtected routeRuName='Анализ артикула'><SkuIdPage /></ProtectedRoute>} />
          ...
          <Route path='/report-profit-loss' element={<Suspense fallback={<LoaderPage />}>{' '}<ReportProfitLoss /></Suspense>} />
          {/* 404 */}
